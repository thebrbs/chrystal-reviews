    ...
    return (
      <div className="reviewListEntry">
        <div className="dinerInfo">
          <div className="profilePhoto"><i class="far fa-user-circle fa-lg"></i></div>
          ...
          <div id="reviewbody">          
            ...
            <button class="reviewlistbutton"><i class="far fa-flag"></i><span class="reviewlistbutton">Report</span></button>
            <button class="reviewlistbutton"><i class="far fa-arrow-alt-circle-up"></i><span class="reviewlistbutton">Helpful</span></button>
          </div>
          <hr></hr>
        </div>
      </div>
